<template>
  <!-- Modal Pesquisa Fornecedor-->
  <div class="modal fade" id="modalPesquisaFornecedor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabelFornecedor" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color: #003366; color:white; font-weight: bold;">
            <label class="tituloPesquisa fs-5" id="staticBackdropLabelFornecedor">Pesquisa de fornecedor</label>
        </div>
                ...
                <tbody class="detalhePesquisa">
                    ...
                    <template v-else>
                        <tr v-for="c in apiDisplayedDados" :key="c">
                            <th scope="row" class="text-center" style="color: blue; cursor: pointer;" @click="setaPesquisa({ tipo: 'fornecedor',obj: c})" data-bs-dismiss="modal">{{ c.codigo }}</th>
            ...
            <div class="mt-4">
              <nav aria-label="Page navigation example">
                <ul class="pagination pagination-sm justify-content-center">
                  <li class="page-fornecedor">
                    <button type="button" class="page-link" v-if="page != 1" @click="page--"> Anterior </button>
                  </li>
                  <li class="page-fornecedor" v-for="pageNumber in pages.slice(page-1, page+5)" :key="pageNumber">
...
/*
    $('#modalPesquisaFornecedor').on('shown', function () {
        alert("aqui");
    })
*/
    export default {
