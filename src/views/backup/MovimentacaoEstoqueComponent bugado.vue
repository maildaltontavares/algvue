...
-->                 <!-- DIV GRID  -->   
                    <div style="height:2000px;overflow: auto; background-color:white  "> 
                        ...
                        <div class="flex-linha"  style="margin-left:3%;width:95%;margin-top: 5px ;  ">   


                            <table class="table-responsive  " style= "width:100%;   "> 
     
                                <tbody  v-for="(i, indice) in aMovimentoItem" :key="indice" style= " width:100% ;background-color:green" >   
                                    ...
                                    <tr  style="margin-left:1%;width:97%;margin-top: 1%;background-color:gray;margin-bottom:5px;
                                           " > 
                                    ...
                                    <tr class="flex-linha-completa" style="margin-left:1%;width:97%;margin-top: 1%;background-color:blue;margin-bottom:5px"  > 
                                    
                                        <td  >
                                            
                                            <div  class="espacoEntreComponentesGrid" style="width: 45%; min-width: 350px; "    > 
                                        ...
                                        <td     v-if="this.tipoMatP == 'ALGOD'  && this.vOperAlteraItem=='N'">
                                                    ...
                                                    <v-autocomplete
                                                        ...
                                                        class="espacoEntreComponentesGrid" 
                                                        bg-color="white"  
                                                        density="compact"
                                        ...
                                        <td  >   
                                                    ...
                                                    <v-text-field
                                                        ...
                                                        ref="lote"  
                                                        maxlength="20"                                         
                                                        style=" width: 300px;min-width: 180px; "  
                                                        class="espacoEntreComponentesGrid" 
                                                        variant="outlined"
                                                        bg-color="white"
                                    ...
                                    <tr class="flex-linha-completa" style="margin-left:6%;width:90%;margin-top: 1%;background-color:white;margin-bottom:5px"  > 
